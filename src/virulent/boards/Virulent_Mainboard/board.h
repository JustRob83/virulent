 ...
 * IO pins assignments.
 */
#define GPIO_NRESET_SOFT            GPIOA, 0
#define GPIO_5V_ENABLE              GPIOA, 1
#define GPIOA_PIN2                  GPIOA, 2
#define GPIO_MOD_FREQ               GPIOA, 3
#define GPIOA_PIN4                  GPIOA, 4
#define GPIOA_PIN5                  GPIOA, 5
#define GPIOA_PIN6                  GPIOA, 6
#define GPIOA_PIN7                  GPIOA, 7
#define GPIOA_PIN8                  GPIOA, 8
#define GPIO_TEAMID0                GPIOA, 9
#define GPIO_TEAMID1                GPIOA, 10
#define GPIO_SWDAT                  GPIOA, 13
#define GPIO_SWCLK                  GPIOA, 14
#define GPIO_SWO                    GPIOA, 15

#define GPIOB_PIN0                  0
#define GPIO_GREEN_LED              GPIOB, 1
#define GPIO_RED_LED                GPIOB, 3
#define GPIO_BLUE_LED               GPIOB, 4
#define GPIOB_PIN5                  5
#define GPIOB_PIN6                  6
#define GPIOB_PIN7                  7
